...
RD_FINISH_O     ,//read finish pulse
WR_FINISH_O     ,
PDATA_O         ,//[MAX_BYTE_NUM*8-1:0] PDATA_O = {0000000000 low_addr_byte(first receive)......high_addr_byte}
...
/////////////////////////////////////////////////////////////////////////////////
reg [7:0] Shift_out_8 = 'hFFFF;
assign SDA_O = Shift_out_8[7];
reg Open_clk = 0 /* synthesis syn_keep = 1 */;
reg Scl_o = 0 /* synthesis syn_keep = 1 */;
...
wire op_edge;
wire [7:0] byte_high;
reg [7:0] State = 0  /* synthesis syn_keep = 1 */ ;  
///////////////////////////////////////////////////////////////////////////////
clk_div_pos_neg__AHDUDP clk_div_pos_neg_u(
    .RST_I          (RST_I),
    .CLK_I          (CLK_I),
    .DIV_CNT_I      (DIV_CNT_I>>1),//must >= 2 [9:0] 
    .CLK_DIV_O      ( ),

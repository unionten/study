...
proc init_gui { IPINST } {
  ...
  ipgui::add_static_text $IPINST -name "reg space" -parent ${Use_Help} -text {0x0000 enable 0 or 1
0x0004 port_num 1~8
0x0008 color_depth  6,8,10,12
0x000c color_space 0~3
0x0010 mem_bytes 2,3,4,8
0x0014 strip_set 0b00_xxx_yyy
xxx:strip_num 1,2,4
yyy:strip_id 0,1,2,3
0x0018 hactive
0x001c vactive}
